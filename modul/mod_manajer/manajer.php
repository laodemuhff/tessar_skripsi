...
$aksi="modul/mod_manajer/aksi_manajer.php";
switch($_GET[act]){
  // Tampil User
  default:
  echo "
				...
				<div class='row'>
						<div class='col-xl-12'>
								<div class='breadcrumb-holder'>
										<h1 class='main-title float-left'>Data Manajer</h1>
				...
				<div class='row'>
						...
						<div class='col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-12'>						
							<div class='card mb-3'>
								...
								echo"
									<button type='button' class='btn btn-success' onclick=\"window.location.href='?module=manajer&act=tambahmanajer';\"><i class='fa fa-plus'></i>Tambah</button>";
									}
									echo"
								</div>
								...
								<div class='card-body'>
									...
									<table id='example1' class='table table-bordered table-hover display'>
										...
										$tampil = mysql_query("SELECT * FROM user LEFT JOIN divisi ON user.id_divisi=divisi.id_divisi WHERE user.level='manajer' ORDER BY user.id_user ASC");
										$no=1;
   ...
   echo"
	<div class='row'>
                    ...
                    <div class='col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6'>						
						<div class='card mb-3'>
							<div class='card-header'>
								<h3><i class='fa fa-check-square-o'></i> Form Tambah Manajer</h3>
								
							</div>
								
							<div class='card-body'>
								
								<form method=POST action='$aksi?module=manajer&act=input'>
  ...
  case "editmanajer":
	...
	<div class='row'>
                    ...
                    <div class='col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6'>						
						<div class='card mb-3'>
							<div class='card-header'>
								<h3><i class='fa fa-check-square-o'></i> Form Edit Manajer</h3>
								
							</div>
								
							<div class='card-body'>
								
								<form method=POST action='$aksi?module=manajer&act=update'>
