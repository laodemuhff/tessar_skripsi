...
<div class="container bg">
  <div class="row-fluid">
    <div class="span12">
      <div>
<center><h5>Laporan Pembelian Dari Tanggal <?php echo"$mulai Sampai Tanggal $selesai";?></h5></center>
  ...
  <table class="table">
   ...
   $tampil = mysql_query("SELECT * FROM detail_pembelian
					...
					WHERE (pembelian.tgl_pembelian BETWEEN '$mulai' AND '$selesai')");
...
echo "<tr><td colspan=2 align=right><b>Grand Total</b> : </td><td align=right>Rp. $total_rp</td></tr>
     ";
    ?>
    </tbody>
  </table>
