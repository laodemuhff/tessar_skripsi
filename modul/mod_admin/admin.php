						...
						<div class='col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-12'>						
							<div class='card mb-3'>
								<div class='card-header'>
									<button type='button' class='btn btn-success' onclick=\"window.location.href='?module=admin&act=tambahadmin';\"><i class='fa fa-plus'></i>Tambah</button>
								</div>
								...
								<div class='card-body'>
									...
									<table id='example1' class='table table-bordered table-hover display'>
										...
										$tampil = mysql_query("SELECT * FROM user WHERE level='admin' ORDER BY id_user ASC");
										$no=1;
										...
										echo"
											<tr>
												...
												<td>$r[email]</td>
												<td>$r[no_telp]</td>
												<td><a href='?module=admin&act=editadmin&id=$r[id_user]' class='btn btn-primary btn-sm' title='Edit' ><i class='fa fa-edit'></i> Edit</a>
													<a href='$aksi?module=admin&act=hapus&id=$r[id_user]' class='btn btn-danger btn-sm' title='Hapus' onClick=\"return confirm('Apakah Anda Yakin Untuk Menghapus Data Ini ?')\"><i class='fa fa-trash'></i> Hapus</a>
												</td>
											</tr>";
   ...
   echo"
	<div class='row'>
                    ...
                    <div class='col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6'>						
						<div class='card mb-3'>
							<div class='card-header'>
								<h3><i class='fa fa-check-square-o'></i> Form Tambah Admin</h3>
  ...
  case "editadmin":
	...
	<div class='row'>
                    ...
                    <div class='col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6'>						
						<div class='card mb-3'>
							<div class='card-header'>
								<h3><i class='fa fa-check-square-o'></i> Form Edit Admin</h3>
